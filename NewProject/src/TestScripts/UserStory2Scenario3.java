...
public class UserStory2Scenario3 {
		...
		Thread.sleep(5000);
		 ...
		 Actions actions = new Actions(driver);
		  ...
		  WebElement element = driver.findElement(By.xpath("//div[@help-id='CurrentAge']//input[@class='ng-pristine ng-valid']"));
			...
			actions.moveToElement(element).click().sendKeys("140000").perform();
...
Starting ChromeDriver 2.39.562718 (9a2698cba08cf5a471a29d30c8b3e12becabb0e9) on port 37311
Only local connections are allowed.
May 07, 2019 11:24:12 PM org.openqa.selenium.remote.ProtocolHandshake createSession
